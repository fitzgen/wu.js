(function (globals) {
    ...
    // the UI thread between every iteration via setTimeout.
    wu.fn.asyncEach = function (fn, context) {
        var that = this;
    ...
    wu.fn.map = function map(fn, context) {
        ...
        context = context || this;
        return wu.Iterator(function next() {
            return fn.call(context, that.next());
        });
    };
    ...
    wu.fn.mapply = function mapply(fn, context) {
        ...
        context = context || this;
        return wu.Iterator(function next() {
            return fn.apply(context, that.next());
        });
    };
